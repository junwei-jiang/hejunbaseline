...
if __name__ == "__main__":
    args = parse_args()
    main(args)
# export NCCL_P2P_DISABLE=1 && export NCCL_IB_DISABLE=1 &&  accelerate launch --main_process_port 25525 --config_file configs/8_16fp.yaml  training_neural_gaffer.py  --dataloader_num_workers 32  --use_ema --gradient_checkpointing   --config configs/neural_gaffer_training.txt